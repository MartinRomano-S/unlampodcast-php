<?php
    ...
    if($noticia->getId()) {
        $result = AsyncFileUploader::uploadFile($_FILES['file'], AsyncFileUploader::IMAGE, "../../news/img/", $noticia->getId());
        
        if($result['success'] == true) {
            $res = $DAONews->updateImagePath($_POST['extraData'], $loggedUser, $result['destination_path']);
